...
main = do
	args <- getArgs
	case args of
		["c", a, b] -> encodeDebug a b
		["d", a, b] -> decode a b
		["-h"] -> putStrLn "Usage:\n./huffman c 'input' 'output' --> compress file\n./huffman d 'input' 'output' --> decompress file"
		["-v"] -> putStrLn "Huffman Text File compressor/decompressor. Version 1.0\n(c) Marcos Felipe Eipper / 2017 ~ @markx3"
		["-l"] -> putStrLn "MIT License"
